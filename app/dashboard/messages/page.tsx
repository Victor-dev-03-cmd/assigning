        ...
        <div className="p-4 border-b border-slate-300 bg-white/50">
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 bg-slate-100 border-none rounded text-sm focus:ring-1 focus:ring-brand-primary transition-all outline-none"
            />
          </div>
        </div>
          ...
          {contacts.map((contact) => (
            ...
            >
              <div className="relative shrink-0">
                <div className="w-12 h-12 rounded-full bg-slate-200 border-2 border-white shadow-sm flex items-center justify-center text-slate-500 overflow-hidden">
              ...
              <div className="flex-1 text-left min-w-0">
                <div className="flex justify-between items-start mb-1">
                  <span className="text-slate-800 group-hover:text-brand-primary transition-colors truncate text-sm tracking-tight">
                    {contact.name}
                  </span>
